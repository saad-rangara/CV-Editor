    ...
    return (
        <div className="flex  min-h-screen bg-gray-100">
            ...
            >
                ...
                <h2 className="text-2xl font-bold mt-8 mb-6 text-gray-800">Additional Details</h2>
                <div className="flex space-x-4">
                    <div className="w-1/2">
                    ...
                    <div className="w-1/2">
                        ...
                        <label htmlFor="driving_licence" className="block text-gray-700 font-medium mb-2">
                            Driving Licence:
                        </label>
                        <input
                            type="text"
                        ...
                        <label htmlFor="birth_place" className="block text-gray-700 font-medium mb-2">
                            Birth Place:
                        </label>
                        <input
                            type="text"
                ...
                <h2 className="text-2xl font-bold mt-8 mb-6 text-gray-800">Personal Profile</h2>
                ...
                <h2 className="text-2xl font-bold mt-8 mb-6 text-gray-800">Work Experience</h2>
                <div className="flex space-x-4">
                    <div className="w-1/2">
                    ...
                    <div className="w-1/2">
                        <label htmlFor="startdate_work" className="block text-gray-700 font-medium mb-2">Start Date:</label>
                        <input
                        ...
                        <label htmlFor="work_summary" className="block text-gray-700 font-medium mb-2">Summary:</label>
                        <textarea
                            name="work_summary"
                            id="work_summary"
                ...
                <h2 className="text-2xl font-bold mt-8 mb-6 text-gray-800">Education</h2>
                <div className="flex space-x-4">
                    <div className="w-1/2" >
                        <label htmlFor="institute" className="block text-gray-700 font-medium mb-2">
                            Institution:
                        </label>
                        <input
                            type="text"
                        ...
                        <input
                            ...
                            className="w-full p-2 mb-4 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                        <label htmlFor="edu_location" className="block text-gray-700 font-medium mb-2">Location:</label>
                        <input type="text"
                            name="edu_location"
                            id="edu_location"
                    ...
                    <div className="w-1/2">
                        ...
                        <input
                            ...
                            className="w-full p-2 mb-4 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                        <label htmlFor="enddate_edu" className="block text-gray-700 font-medium mb-2">End Date:</label>
                        <input
                            type="date"
                            name="enddate_edu"
                            id="enddate_edu"
                        ...
                        <label htmlFor="edu_summary" className="block text-gray-700 font-medium mb-2" >Summary:</label>
                        <textarea
                            name="edu_summary"
                            id="edu_summary"
            ...
            <div className="w-1/2 h-screen overflow-y-auto bg-gray-200 p-8 ">
                ...
                <div className="flex justify-center space-x-4 mb-4">
                    ...
                    <button onClick={() => setScale(prevScale => Math.max(prevScale - 0.1, 0.5))}
                        className="px-4 py-2 bg-blue-500 text-white rounded z-50">
                        -
                    </button>
                ...
                <div className="bg-sky-50 ml-32 h-[600px] w-[400px]"
                    style={{ transform: `scale(${scale})` }}
                >
                    <div className="flex justify-between">
                        <div className="flex flex-col">
                            <p className="mt-12 ml-4 text-gray-600 text-xl">{state.first_name} {state.last_name}
                            </p>
                            <p className="ml-4 text-gray-600 text-xs"> {state.position} </p>
                        </div>
                        <div className="flex flex-col mt-12 ">
                            <p className=" ml-4 text-gray-600 text-xs">{state.address}</p>
                            <p className="text-xs mr-4">{state.city} {state.postcode}</p>
                            <p className="mt-4 ml-4 mr-4 text-gray-600 text-xs">{state.phonenumber}</p>
                    ...
                    <div className="flex  justify-between">
                        <div>
                            {state.driving_licence || state.gender || state.date_of_birth || state.nationality || state.birth_place ? <p className='text-xl ml-4'> Additional Info </p> : <></>}
                            {state.driving_licence ? <p className="ml-4 mr-4 text-gray-600 text-xs">Driving Licence {state.driving_licence} </p>
                                : <></>}

                            {state.gender ? <p className="ml-4 mr-4 text-gray-600 text-xs">
                                Gender  {state.gender}</p> : <></>}
                            {state.date_of_birth ? <p className="ml-4 mr-4 text-gray-600 text-xs">
                                Date Of Birth  {state.date_of_birth}</p> : <></>}
                            {state.nationality ? <p className="ml-4 mr-4 text-gray-600 text-xs">Nationality {state.nationality}
                            </p> : <></>}
                            {state.birth_place ? <p className="ml-4 mr-4 text-gray-600 text-xs">Birth Place   {state.birth_place}
                            </p> : <></>}
                            {state.details ? <p className="ml-4 mr-4 text-gray-600 text-xl"> About </p> : <></>}
                            <p className="ml-4 mr-4 text-gray-600 text-xs" > {state.details}</p>
                        </div>
                        <div className="flex flex-col ">
                            {state.jobtitle || state.company || state.location || state.startdate_work || state.enddate_work ||
                                state.work_summary ? <p className="ml-4 mr-4 text-gray-600 text-xl"> Work Experiance</p> : <></>}
                            {state.jobtitle ? <p className="ml-4 mr-4 text-gray-600 text-xs">{state.jobtitle}</p> : <></>}
                            {state.company ? <p className="ml-4 mr-4 text-gray-600 text-xs">{state.company}</p> : <></>}
                            {state.location ? <p className="ml-4 mr-4 text-gray-600 text-xs">{state.location}</p> : <></>}
                            {state.startdate_work ? <p className="ml-4 mr-4 text-gray-600 text-xs">{state.startdate_work}</p> : <></>}
                            {state.enddate_work ? <p className="ml-4 mr-4 text-gray-600 text-xs">{state.enddate_work}</p> : <></>}
                            {state.work_summary ? <p className="ml-4 mr-4 text-gray-600 text-xs">{state.work_summary}</p> : <></>}
                            {state.institute || state.degree || state.edu_location || state.startdate_edu || state.enddate_edu ||
                                state.edu_summary ?
                                <p className="ml-4 mr-4 text-gray-600 text-xl">Education</p> : <></>}
                            {state.institute ? <p className="ml-4 mr-4 text-gray-600 text-xs">{state.institute}</p> : <></>}
                            {state.degree ? <p className="ml-4 mr-4 text-gray-600 text-xs">{state.degree}</p> : <></>}
                            {state.edu_location ? <p className="ml-4 mr-4 text-gray-600 text-xs">{state.edu_location}</p> : <></>}
                            {state.startdate_edu ? <p className="ml-4 mr-4 text-gray-600 text-xs">{state.startdate_edu}</p> : <></>}
                            {state.enddate_edu ? <p className="ml-4 mr-4 text-gray-600 text-xs">{state.enddate_edu}</p> : <></>}
                            {state.edu_summary ? <p className="ml-4 mr-4 text-gray-600 text-xs">{state.edu_summary}</p> : <></>}
                        </div>

                    </div>
                    {state.skills ? <p className="ml-4 mr-4 text-gray-600 text-xl">Skill</p> : <></>}
